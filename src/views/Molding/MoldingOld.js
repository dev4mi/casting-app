...
import MoldingDetailsTable from '../Components/MoldingDetailsTable';
...
const MoldingView = () => {
const [moldingDetails, setMoldingDetails] = useState([]);
...
const { productParts, getAllProductParts } = useContext(ProductPartsContext);
  ...
  const { getAllMoldingData } = useContext(MoldingContext);
  ...
  const handleAddRecord = () => {
    if (selectedCompany && selectedProduct) {
      ...
      const relevantParts = productParts.filter(pp =>
          ...
          <Card variant="outlined">
            ...
            <CardContent padding="30px">
              <form encType='multipart/form-data' onSubmit={handleSubmit}>
               ...
               <MoldingDetailsTable moldingDetails={moldingDetails} />
            </CardContent>
          </Card>
        </Grid>
      </Grid>
